      ...
      <div class="row">
          <div class="col-md-12 ">
              <div class="panel panel-default">
                  <div class="panel-heading panel-title">Ingreso de Tipo de Gasto</div>
                  ...
                  <div class="panel-body">
                    ...
                    {!! Form::open(['route' => 'tipoGastos.store', 'method' => 'POST']) !!}
                      ...
                      <div class="panel-body text-right">
                        <button type="button" class="btn btn-default" style="border-color: white"><a href="{{ route('indexTipoGasto', $empresa_id) }}" title="Cerrar"><span class="glyphicon glyphicon-remove-sign" aria-hidden="true" style="font-size:32px; color: black"></span></a>
