            ...
            <div class="panel panel-primary">
                 <div class="panel-heading panel-title" style="height: 65px">
                    Editar Detalle Presupuesto {{ $detallePresupuesto->ID }}
                     <button type="button" class="btn btn-default" style="border-color: white; float: right"><a href="{{ route($rutaPresupuesto, $detallePresupuesto->PRESUPUESTO_ID . '-' . $tipo) }}" title="Cerrar"><span class="glyphicon glyphicon-remove-sign" aria-hidden="true" style="font-size:32px; color: black"></span></a></button>
