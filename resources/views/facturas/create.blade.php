                  ...
                  <div class="panel-body">
                    ...
                    {!! Form::open(['route' => 'facturas.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                      ...
                      <div class="panel-body text-right">
                        <button type="button" class="btn btn-default" style="border-color: white"><a href="{{ route('liquidaciones.edit', $liquidacion_id) }}" title="Cerrar"><span class="glyphicon glyphicon-remove-sign" aria-hidden="true" style="font-size:32px; color: black"></span></a>
