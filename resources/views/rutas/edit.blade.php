            ...
            <div class="panel panel-primary">
                 <div class="panel-heading panel-title" style="height: 65px">
                    Editar Ruta {{ $ruta->DESCRIPCION }} esta es la continuacion asi de larga {{$ruta->EMPRESA_ID}}
                     <button type="button" class="btn btn-default" style="border-color: white; float: right"><a href="{{ route('indexRuta', $ruta->EMPRESA_ID . '-Rutas') }}" title="Cerrar"><span class="glyphicon glyphicon-remove-sign" aria-hidden="true" style="font-size:32px; color: black"></span></a></button>
