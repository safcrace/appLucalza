                 ...
                 <div class="panel-body">
                   ...
                   {!! Form::model($ruta, ['route' => ['rutas.update', $ruta->ID], 'method' => 'PATCH']) !!}
                     ...
                     <div class="panel-body text-right">
                       <button type="button" class="btn btn-default" style="border-color: white"><a href="{{ route('indexRuta', $ruta->EMPRESA_ID) }}" title="Cerrar"><span class="glyphicon glyphicon-remove-sign" aria-hidden="true" style="font-size:32px; color: black"></span></a>
