                  ...
                  <div class="panel-body">
                    ...
                    {!! Form::open(['route' => 'proveedores.store', 'method' => 'POST']) !!}
                      ...
                      <div class="panel-body text-right">
                        <button type="button" class="btn btn-default" style="border-color: white"><a href="{{ route('indexProveedor', $empresa_id) }}" title="Cerrar"><span class="glyphicon glyphicon-remove-sign" aria-hidden="true" style="font-size:32px; color: black"></span></a>
